  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src="./img/log.png" alt="Logoipsum" height="50" width="80" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/uday.aryan.92167789"
            ...
            <li>
              <a
                href="https://www.instagram.com/udayaryan_/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/uday-kumar-mahto-b26a4920a/ "
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
